...
def convert_gravity_value(value):
    ...
    try:
        num = convert_to_float(value.lower().strip().replace(" standard", ""))
        return num
    except:
...
def read_csv(filepath, encoding='utf-8', newline='', delimiter=','):
    ...
    WARN: IfÂ newline=''Â is not specified, newlines '\n' or '\r\n' embedded inside quoted fields
